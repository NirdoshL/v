      ...
      <section className="h-[240px] md:h-[360px] min-w-[180px] md:min-w-[210px] pb-10 text-start transform duration-500 hover:-translate-y-2 cursor-pointer overflow-hidden border rounded">
        ...
        <div className="flex flex-row justify-between items-center px-1">
          <div className="flex flex-col">
            <h1 className="text-md md:text-lg font-medium my-0.5 md:my-2 px-5 truncate">
              Vastra Wears
            </h1>
            <h2 className="text-sm md:text-lg font-medium text-gray-600  my-1.5 md:mb-2 px-5">
              Rs {0.0}
            </h2>
          </div>
        ...
        <div className="flex items-center justify-between gap-2 mt-1 md:mt-2">
          <div className="space-x-1 px-1 flex justify-start ">
          ...
          <Button className="bg-background mx-2 shadow-none hover:bg-brandcolor text-brandcolor hover:text-secondary">
